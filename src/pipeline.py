...
def run_pipeline():
    ...
    models = {
        "Logistic Regression": LogisticRegressionModel(random_state=15, max_iter=1000),#1000 по базі, но лучше 100, не так довго крутитиме
        #"Decision Tree": DecisionTreeModel(random_state=15, max_depth=500),#більше 500 нема сенсу
        #"Random Forest": RandomForestModel(random_state=15, n_estimators=25),#100 або 50
